...
#ifndef __Orchids__featuresLoudness__
#define __Orchids__featuresLoudness__

#include "Orchids.h"

/**
 *  @class FeaturesLoudness
 *  @brief Definition for loudness feature
 *  This class defines the generic behavior for loudness feature
 */
class FeaturesLoudness : public Features
{
public:
    /**
     *  @brief Constructor
     ...
     */
    FeaturesLoudness(string name): Features(name){};
