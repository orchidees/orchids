...
#ifndef __Orchids__featuresPartialsAmplitude__
#define __Orchids__featuresPartialsAmplitude__

#include "Orchids.h"

/**
 *  @class FeaturesPartialsAmplitude
 *  @brief Feature definition
 *  This class defines the behavior of the temporal evolution for partials amplitude structure
 */
class FeaturesPartialsAmplitude : public Features
{
public:
    /**
     *  @brief Constructor
     ...
     */
    FeaturesPartialsAmplitude(string name): Features(name){};
