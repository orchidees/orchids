...
#ifndef __Orchids__featuresSpectralSpread__
#define __Orchids__featuresSpectralSpread__

#include "Orchids.h"

/**
 *  @class FeaturesSpectralSpread
 *  @brief Definition of spectral spread
 *  This class defines the behavior of the temporal evolution for spectral spread value
 */
class FeaturesSpectralSpread : public Features
{
public:
    /**
     *  @brief Constructor
     ...
     */
    FeaturesSpectralSpread(string name): Features(name){};
