...
#ifndef __Orchids__featuresMelMeanAmplitude__
#define __Orchids__featuresMelMeanAmplitude__

#include "Orchids.h"

/**
 *  @class FeaturesMelMeanAmplitude
 *  @brief Feature definition
 *  This class defines the behavior of the mean values for partials amplitude structure
 */
class FeaturesMelMeanAmplitude : public Features
{
public:
    /**
     *  @brief Constructor
     ...
     */
    FeaturesMelMeanAmplitude(string name): Features(name){};
