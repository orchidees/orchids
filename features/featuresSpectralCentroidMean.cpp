...
#include "featuresSpectralCentroidMean.h"



vector<string>          FeaturesSpectralCentroidMean::depandancy()
{
...
void                    FeaturesSpectralCentroidMean::analysis()
{
    
}

variant                 FeaturesSpectralCentroidMean::addition(PopulationPtr population)
{
    int                 i, j;
...
matrixPtr                  FeaturesSpectralCentroidMean::compare(features& soundsetFeatures, sqlStruct& targetFeatures)
{
    int                    i;
...
void FeaturesSpectralCentroidMean::transpose(IndividualPtr individual)
{
    
}

matrixPtr FeaturesSpectralCentroidMean::neutral()
{
