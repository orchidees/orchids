...
#ifndef __Orchids__featuresSpectralSpreadMean__
#define __Orchids__featuresSpectralSpreadMean__

#include "Orchids.h"

/**
 *  @class FeaturesSpectralSpreadMean
 *  @brief Definition of mean spectral spread
 *  This class defines the behavior of the mean values for spectral spread value
 */
class FeaturesSpectralSpreadMean : public Features
{
public:
    /**
     *  @brief Constructor
     ...
     */
    FeaturesSpectralSpreadMean(string name): Features(name){};
