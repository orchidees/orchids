...
#ifndef __Orchids__featuresMelAmplitude__
#define __Orchids__featuresMelAmplitude__

#include "Orchids.h"

/**
 *  @class FeaturesMelAmplitude
 *  @brief Feature definition
 *  This class defines the behavior of the temporal evolution for Mel amplitude structure
 */
class FeaturesMelAmplitude : public Features
{
public:
    /**
     *  @brief Constructor
     ...
     */
    FeaturesMelAmplitude(string name): Features(name){};
